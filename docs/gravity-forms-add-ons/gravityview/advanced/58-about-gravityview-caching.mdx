...
viewCount: "4937"
lastPublishedAt: "2022-12-28T10:59:21Z"
...
updatedBy: "459439"
updatedAt: "2022-12-28T10:59:21Z"
...
A quick way to clear a View's cache is by adding the ?cache parameter to the end of the URL where your View is located.   
Example: https://example.com/view/directory/?cache
 ...
 **You can disable the cache permanently by [downloading and installing this plugin](https://github.com/katzwebservices/gv-snippets/archive/addon/2863-disable-cache.zip).**

You can also add the following code [to your functions.php file](https://docs.gravitykit.com/article/210-where-to-put-code-samples):
